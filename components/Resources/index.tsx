      ...
      <div className="flex flex-col md:flex-row items-center justify-center md:justify-start md:ml-22 md:space-x-5 mb-8">
        <button
          ...
          className={`textcat w-[130px] md:w-[200px] py-2 text-white font-poppins text-[20px] md:text-[30px] rounded ${
            selectedCategory === 'Data Analytics' ? 'bg-[hsla(227,60%,17%,1)]' : 'bg-transparent'
          }`}
        >
          ANALYTICS
        </button>
        <button
          ...
          className={`textcat w-[170px] md:w-[250px] py-2 text-white font-poppins text-[20px] md:text-[30px] rounded ${
            selectedCategory === 'Management' ? 'bg-[hsla(227,60%,17%,1)]' : 'bg-transparent'
          }`}
        >
          MANAGEMENT
        </button>
