...
const EventsPage: React.FC = () => {
  return (
    <div className="relative">
      ...
      <div className="bg-gradient-to-r from-[#1B1F2D] via-[#172C28] to-[#111648] flex items-center justify-center md:h-[354px] p-5">
        <div className="flex flex-wrap items-center justify-between w-full max-w-7xl md:flex-row flex-col">
          <div className="flex-1 mb-4 md:mb-0 md:mr-4">
            <img
              src="./images/table.jpg"
              alt="Your Image Description"
              className="object-cover w-full md:w-[571px] md:h-[278px] rounded-[13px]"
              loading="lazy"
              style={{
                display: 'flex',
                alignItems: 'center',
          ...
          <div className="flex-1 ml-4 text-white md:ml-0">
            <h2 className="font-poppins text-center text-[25px] md:text-[36px] font-bold mb-4">Our Mission</h2>
            <p className="font-poppins text-center text-[15px] md:text-left md:text-[24px] leading-[26px]">
      ...
      <div className="flex flex-wrap pt-8 p-4 mb-15 md:w-9/10 m-auto md:pr-0 md:pb-0 md:pl-20 mx-auto">
        <div className="flex flex-col justify-center w-full md:pr-8 md:w-1/2">
          <h1 className="text-[30px] text-center md:text-left mb-5 md:text-[48px] md:pr-10">
            <span className="gradient-textABTUS font-poppins">Experienced Leadership</span>
          </h1>
          <p className="font-poppins text-sm text-center md:text-[20px] md:text-left leading-[26px]">
