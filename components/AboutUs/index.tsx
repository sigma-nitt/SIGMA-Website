...
const EventsPage: React.FC = () => {
  return (
    <div className="relative">
      <div className="flex flex-col lg:flex-row py-[30px] lg:py-[60px]">
        <div className="flex flex-col items-center lg:items-start lg:ml-[5%] xl:ml-[111px] mt-[120px] lg:mt-[169px] lg:w-[50%]">
          <div className="flex justify-center lg:justify-start items-center text-center w-[90%] xl:w-[70%]">
            ...
            <div className="font-poppins justify-center text-center lg:text-left text-[4.5vh] md:text-[6vh] lg:text-[3.8vw] xl:text-[3.1vw] leading-[45px] lg:leading-[55px]">
              <span className="gradient-textABTUS">We Power</span> 
              <span className="font-semibold"> the mindset of business</span>
            </div>
          </div>
          <div className="flex justify-center lg:justify-start items-center text-center font-acumin text-justify lg:text-left mt-[15px] lg:mt-[21px] md:text-[2.5vh] lg:text-[1.6vw] xl:text-[1.3vw] lg:leading-[26px] w-[90%] md:w-[80%] lg:w-[95%] xl:w-[85%]">
          {/* <div className="flex justify-center lg:justify-start items-center text-center font-acumin text-justify lg:text-left mt-[15px] lg:mt-[21px] md:text-[2vw] lg:text-[1.5vw] xl:text-[1.3vw] lg:leading-[26px] w-[90%] md:w-[80%] lg:w-[95%] xl:w-[85%]"> */}
          {/* <div className="flex justify-center lg:justify-start items-center text-center font-acumin text-justify lg:text-left mt-[15px] lg:mt-[21px] md:text-[17px] lg:text-[1.5vw] xl:text-[20px] lg:leading-[26px] w-[90%] md:w-[80%] lg:w-[95%] xl:w-[85%]"> */}
        ...
        <div className="flex justify-center items-center text-center mt-12 lg:mt-[12%] xl:mt-[8%] lg:w-[50%]">
          <Image className="w-[80%] md:w-[60%] lg:w-[80%] pointer-events-none select-none"
      ...
      <div className="bg-gradient-to-r from-[#1B1F2D] via-[#172C28] to-[#111648] flex h-auto p-8 lg:p-2 xl:p-8">
        <div className="flex flex-col lg:flex-row items-center lg:items-left ">
          <div className="flex lg:ml-[5%] xl:ml-[6.5%]">
            {/* <Image className="flex items-center justify-center m-auto w-[80%] xl:w-[571px] xl:h-[278px] rounded-[13px] pointer-events-none select-none" */}
            <Image className="flex items-center justify-center m-auto w-[75vw] lg:w-[70vh] xl:w-[40vw] h-auto rounded-[13px] pointer-events-none select-none"
          ...
          <div className="flex flex-col text-white mt-4">
            <div>
              {/* <p className="font-acumin text-center lg:text-left text-[25px] lg:text-[35px] xl:text-[36px] lg:leading-[43.2px] lg:ml-[58px] font-normal">Our Mission</p> */}
              <p className="font-acumin text-center lg:text-left text-[25px] md:text-[3.5vw] lg:text-[2.6vw] xl:text-[2.1vw] lg:leading-[43.2px] lg:ml-[58px] font-normal">Our Mission</p>
            </div>
            <div className="mt-[10px] lg:mt-[0px] font-acumin m-auto text-justify lg:text-left text-[15px] md:text-[2.5vh] lg:text-[1.6vw] xl:text-[1.3vw] lg:mt-[21px] w-[90%] lg:w-[649px] lg:ml-[60px] leading-[26px] font-normal">
      ...
      <div className="flex flex-col lg:flex-row lg:mb-[80px]">
        <div className="flex flex-col items-center lg:items-start lg:ml-[5%] xl:ml-[111px] mt-[50px] lg:mt-[59px] lg:w-[50%]">
          <div className="flex justify-center lg:justify-start items-center text-center w-[90%] lg:w-[95%]">
            {/* <div className="font-poppins justify-center text-center lg:text-left text-[30px] md:text-[40px] lg:text-[43px] xl:text-[48px] leading-[45px] lg:leading-[55px]"> */}
            <div className="font-poppins justify-center text-center lg:text-left text-[4.5vh] md:text-[6vh] lg:text-[3.8vw] xl:text-[3.1vw] leading-[45px] lg:leading-[55px]">
        ...
        <div className="flex justify-center items-center text-center mt-8 lg:mt-[8%] xl:mt-[4%] lg:w-[50%]">
          <Image className="w-[35%] md:w-[20%] lg:w-[35%] pointer-events-none select-none"
