  ...
  return (
    <div className="overflow-hidden pt-35 md:pt-40 xl:pt-[147px] pb-[125px]">
      <div className="hero-section flex flex-col lg:flex-row justify-center items-center">
        ...
        >
          <Image
            className="imgchange lg:ml-[150px] absolute justify-center lg:mt-[32px] w-[300px] h-[350px] md:w-auto md:h-[400px] lg:w-[450px] lg:h-[578px] transition-all duration-500 ease-out"
