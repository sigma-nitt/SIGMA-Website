        ...
        <div className="w-[85%] flex flex-col items-center justify-center m-auto">
          <div className="flex flex-col md:flex-row justify-between mb-[20px] gap-4 lg:gap-8">
              <div className="flex items-center justify-center order-1">
                <Image className="w-[90%] md:w-[100%] lg:w-[90%] h-auto pointer-events-none select-none"
              ...
              <div className="flex items-center justify-center order-2">
                <Image className="w-[30%] md:w-[250px] lg:w-[200px] h-auto pointer-events-none select-none"
