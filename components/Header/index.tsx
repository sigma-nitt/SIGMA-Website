...
//             navigationOpen &&
//             "navbar !visible no-scrollbar mt-3 md:mt-4 h-[250px] max-h-[400px] xl:h-auto rounded-md bg-background p-5 md:p-7.5 shadow-solid-5 dark:bg-background xl:p-0 xl:shadow-none xl:dark:bg-background"
//           }`}
//         >
//           <nav>
...
const Header = () => {
  ...
  return (
    <header
      className="fixed left-0 top-0 z-50 w-full py-3 md:py-4 lg:py-5 xl:py-7 bgcustomgradient transition duration-100 dark:bg-custom-gradient font-poppins">
      <div className="relative mx-auto max-w-c-1390 items-center justify-between px-4 md:px-8 xl:flex 2xl:px-0">
        <div className="flex items-center justify-between mr-[60px]">
          <a href="/" className="ml-[3vw] md:ml-[2vw] lg:ml-[3vw] xl:ml-[1.3vw]">
            <Image
              src="/images/sigma symbol.png"
              alt="logo"
              width={55}
              height={105}
              className="h-auto w-[9vw] md:w-[6vw] lg:w-[5vw] xl:w-full"
            />
          </a>
        ...
        <div
          className={`invisible h-0 w-full items-center justify-between xl:visible xl:flex xl:h-auto xl:w-full ${
            navigationOpen &&
            "navbar !visible no-scrollbar mt-3 md:mt-2 lg:mt-4 h-[250px] md:h-[270px] lg:h-[350px] xl:h-auto rounded-md bg-background p-5 md:p-7.5 shadow-solid-5 dark:bg-background xl:p-0 xl:shadow-none xl:dark:bg-background"
          }`}
        >
          <nav>
            <ul className="flex flex-col xl:flex-row xl:items-center lg:gap-[10px] xl:gap-[56px] text-[15px] xl:text-[20px]">
              {menuData.map((menuItem) => (
                <li key={menuItem.id} className={menuItem.submenu && "group relative"}>
                  {menuItem.submenu ? (
                    <>
          ...
          <div className="mt-2 lg:mt-5 xl:mt-0 flex items-center gap-6 xl:mt-0 text-black font-poppins">
            <Link
              href="/contactus"
              onClick={() => {
                toggleMobileMenu(); 
