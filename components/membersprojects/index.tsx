...
const MembersProjectsComponent: React.FC = () => {
  ...
  return (
    <div className="bg-[linear-gradient(85.14deg,_#000000_5.41%,_#000000_19.17%,_#111648_99.67%)] flex flex-col md:flex-row items-center justify-center h-auto md:h-[150px] lg:h-[210px] p-8 md:p-0">
      <div className="flex flex-row md:w-1/3 items-center justify-center transition-transform duration-300 hover:scale-105">
        <svg className="h-[61px] md:mr-2 lg:mr-4 mb-3 lg:mb-0" viewBox="0 0 67 61" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="flex flex-row md:w-1/3 items-center justify-center transition-transform duration-300 hover:scale-105">
        <svg className="h-[76px] md:mr-2 lg:mr-4 mb-3 lg:mb-0" viewBox="0 0 50 76" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="flex flex-row md:w-1/3 items-center justify-center transition-transform duration-300 hover:scale-105">
        <svg className="h-[63px] md:mr-2 lg:mr-4 mb-3 lg:mb-0" viewBox="0 0 77 63" fill="none" xmlns="http://www.w3.org/2000/svg">
