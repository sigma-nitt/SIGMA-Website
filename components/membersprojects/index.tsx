...
const MembersProjectsComponent: React.FC = () => {
  ...
  return (
    <div className="bg-[linear-gradient(85.14deg,_#000000_5.41%,_#000000_19.17%,_#111648_99.67%)] flex flex-col md:flex-row flex-wrap items-center h-auto md:h-[210px] p-4 items-center justify-center gap-[80px]">
