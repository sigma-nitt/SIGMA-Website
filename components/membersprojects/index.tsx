  ...
  return (
    <div className="members-projects" style={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap' }}>
      <div style={{ flex: '1 1 25%', display: 'flex', flexDirection: 'row', alignItems: 'center', textAlign: 'left', marginLeft: '137px', transition: 'transform 0.3s' }} className="hover-enlarge">
        ...
        <h1 className="font-poppins p-1 w-[203px] text-white text-left mt-3 text-md md:text-lg">{projects}+ real-life Projects and counting</h1>
      </div>
      ...
      <div style={{ flex: '1 1 25%', display: 'flex', flexDirection: 'row', alignItems: 'center', textAlign: 'left', margin: '5px', transition: 'transform 0.3s' }} className="hover-enlarge">
        ...
        <h1 className="font-poppins p-1 w-[294px] text-white text-left mt-3 text-md md:text-lg mt-10">A budding place for business enthusiasts</h1>
      </div>
      ...
      <div style={{ flex: '1 1 25%', display: 'flex', flexDirection: 'row', alignItems: 'center', textAlign: 'left', margin: '5px', transition: 'transform 0.3s' }} className="hover-enlarge">
        ...
        <h1 className="font-poppins p-1 w-[258px] text-white text-left mt-3 text-md md:text-lg mt-10">{events}+ Events brainstormed and managed</h1>
      </div>
    </div>
  );
};
