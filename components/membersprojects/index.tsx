...
const MembersProjectsComponent: React.FC = () => {
  ...
  // return (
  //   <div className="bg-[linear-gradient(85.14deg,_#000000_5.41%,_#000000_19.17%,_#111648_99.67%)] flex flex-col md:flex-row flex-wrap items-center h-auto md:h-[210px] items-center justify-center lg:gap-[80px] p-4 md:p-0">
  //     <div className="flex flex-row items-center md:basis-1/4 transition-transform duration-300 hover:scale-105">
  ...
  return (
    <div className="bg-[linear-gradient(85.14deg,_#000000_5.41%,_#000000_19.17%,_#111648_99.67%)] flex flex-col md:flex-row items-center justify-center h-auto md:h-[210px] lg:gap-[80px] p-8 md:p-0">
      <div className="flex flex-row md:w-1/3 items-center justify-center transition-transform duration-300 hover:scale-105">
        <svg className="h-[61px] md:mr-4 mb-3 md:mb-0" viewBox="0 0 67 61" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M24.3333 61L23 51.24C22.2778 50.9858 21.5978 50.6808 20.96 50.325C20.3222 49.9692 19.6967 49.5879 19.0833 49.1812L9.16667 52.9937L0 38.5062L8.58333 32.5588C8.52778 32.2029 8.5 31.8603 8.5 31.5309V29.4722C8.5 29.1407 8.52778 28.7971 8.58333 28.4412L0 22.4937L9.16667 8.00625L19.0833 11.8187C19.6944 11.4121 20.3333 11.0308 21 10.675C21.6667 10.3192 22.3333 10.0142 23 9.76L24.3333 0H42.6667L44 9.76C44.7222 10.0142 45.4033 10.3192 46.0433 10.675C46.6833 11.0308 47.3078 11.4121 47.9167 11.8187L57.8333 8.00625L67 22.4937L58.4167 28.4412C58.4722 28.7971 58.5 29.1407 58.5 29.4722V31.5278C58.5 31.8593 58.4444 32.2029 58.3333 32.5588L66.9167 38.5062L57.75 52.9937L47.9167 49.1812C47.3056 49.5879 46.6667 49.9692 46 50.325C45.3333 50.6808 44.6667 50.9858 44 51.24L42.6667 61H24.3333ZM33.6667 41.175C36.8889 41.175 39.6389 40.1329 41.9167 38.0488C44.1944 35.9646 45.3333 33.4483 45.3333 30.5C45.3333 27.5517 44.1944 25.0354 41.9167 22.9512C39.6389 20.8671 36.8889 19.825 33.6667 19.825C30.3889 19.825 27.6244 20.8671 25.3733 22.9512C23.1222 25.0354 21.9978 27.5517 22 30.5C22.0022 33.4483 23.1278 35.9646 25.3767 38.0488C27.6256 40.1329 30.3889 41.175 33.6667 41.175Z" fill="#19FB9B"/>
        </svg>
        <h1 className="font-poppins p-1 w-full md:w-[203px] text-white text-center md:text-left text-sm lg:text-lg">{projects}+ real-life Projects and counting</h1>
      </div>
      ...
      <div className="flex flex-row md:w-1/3 items-center justify-center transition-transform duration-300 hover:scale-105">
        ...
        <h1 className="font-poppins p-1 w-full md:w-[294px] text-white text-center md:text-left text-sm lg:text-lg">A budding place for business enthusiasts</h1>
      </div>
      ...
      <div className="flex flex-row md:w-1/3 items-center justify-center transition-transform duration-300 hover:scale-105">
        <svg className="h-[63px] md:mr-4 mb-3 md:mb-0" viewBox="0 0 77 63" fill="none" xmlns="http://www.w3.org/2000/svg">
         ...
         <h1 className="font-poppins p-1 w-full md:w-[258px] text-white text-center md:text-left text-sm lg:text-lg">{events}+ Events brainstormed and managed</h1>
      </div>
    </div>
  );
};
