...
const MembersProjectsComponent: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div style={{ display:'flex', textAlign: 'center', margin: '5px', flex: 1, transition: 'transform 0.3s' }} className="hover-enlarge">
        <svg className="pr-2" width="67" height="61" viewBox="0 0 67 61" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <h1 className="p-1 w-80 text-white text-left mt-3 text-md md:text-xl mt-10">{projects}+ real-life Projects and counting</h1>
        {/* <div className="white-line" style={{ borderTop: '8px solid white', width: '30%', margin: 'auto', marginTop: '30px', marginBottom: '10px', borderRadius: '10px' }}></div> */}
      </div>
      ...
      <div style={{ display:'flex', textAlign: 'center', margin: '5px', flex: 1, transition: 'transform 0.3s' }} className="hover-enlarge">
        <svg className="pr-2" width="50" height="76" viewBox="0 0 50 76" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <h1 className="p-1 w-80 text-white text-left mt-3 text-md md:text-xl mt-10">A budding place for business enthusiasts </h1>
        {/* <div className="white-line" style={{ borderTop: '8px solid white', width: '30%', margin: 'auto', marginTop: '30px', marginBottom: '10px', borderRadius: '20px' }}></div> */}
      </div>

      <div style={{ display:'flex', textAlign: 'center', margin: '5px', flex: 1, transition: 'transform 0.3s' }} className="hover-enlarge">
        <svg className="pr-2" width="77" height="63" viewBox="0 0 77 63" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <h1 className="p-1 w-80 text-white text-left mt-3 text-md md:text-xl mt-10">{events}+ Events brainstormed and managed </h1>
        {/* <div className="white-line" style={{ borderTop: '8px solid white', width: '30%', margin: 'auto', marginTop: '30px', marginBottom: '10px', borderRadius: '20px' }}></div> */}
      </div>
